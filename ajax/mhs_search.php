...
<div class="table-responsive">
    ...
    <nav id="navigation">
        <ul class="pagination justify-content-center">
            ...
            <li class="page-item"><button class="page-link" data-page="<?= ($halamanAktif - 1) ?>" aria-label="Previous"><span
                        aria-hidden="true">&laquo;</span></button></li>
            <?php else : ?>
            <li class="page-item"><button class="page-link opacity-50 disabled" data-page="#" aria-label="Previous"><span
                        aria-hidden="true">&laquo;</span></button></li>
            <?php endif; ?>
            ...
            <li class="page-item"><button class="page-link" data-page="<?= ($halamanAktif + 1) ?>" aria-label="Next"><span
                        aria-hidden="true">&raquo;</span></button></li>
            <?php else : ?>
            <li class="page-item"><button class="page-link opacity-50 disabled" data-page="#" aria-label="Next"><span
                        aria-hidden="true">&raquo;</span></button></li>
            <?php endif; ?>
        </ul>
    </nav>
